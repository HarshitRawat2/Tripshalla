...
export default function HeroHeader({ 
  slides = [
    { url: "/src/assets/1.jpg", title: "INDIA Tour Packages", discount: "40% OFF", price: "5,999" },
    { url: "/src/assets/2.jpg", title: "SIKKIM Adventure", discount: "30% OFF", price: "7,499" },
    { url: "/src/assets/3.jpg", title: "SIKKIM Adventure", discount: "30% OFF", price: "7,499" },
    { url: "/src/assets/4.jpg", title: "SIKKIM Adventure", discount: "30% OFF", price: "7,499" },
    { url: "/src/assets/5.jpg", title: "SIKKIM Adventure", discount: "30% OFF", price: "7,499" }
  ] 
}) {
...
const [isEnquiryOpen, setIsEnquiryOpen] = useState(false);
  ...
  return (
    <header className="relative h-screen w-full overflow-hidden bg-black">
      ...
      {/* Navigation Arrows */}
      <button onClick={prevSlide} className="absolute left-6 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full border border-white/30 text-white hover:bg-white/10 transition-colors">
        <ChevronLeft size={32} />
      </button>
      <button onClick={nextSlide} className="absolute right-6 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full border border-white/30 text-white hover:bg-white/10 transition-colors">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center text-white px-4">
        ...
        >
          Get up to <span className="text-yellow-400 font-bold">{slides[currentIndex].discount}</span> on
        </motion.p>
        ...
        >
          <p className="text-lg text-gray-200">
            Starting at <span className="line-through opacity-60 mr-2">INR 9,998</span> 
            <span className="text-2xl font-bold text-white">INR {slides[currentIndex].price}</span> /Adult
          </p>
